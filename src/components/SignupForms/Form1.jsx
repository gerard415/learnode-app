    ...
    return (
        <div>
            <div className='w-full flex flex-col gap-2'>
                ...
                <input value={props.values.username} onChange={props.handleChange} onBlur={props.handleBlur} className='w-full focus:ring-green-400 focus:ring-2 h-10 rounded-md outline-none px-5 text-white bg-opacity-10 bg-white' />
            </div>
