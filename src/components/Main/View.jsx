...
export default function View(props) {
  ...
  const gotoNum = number => {
    ...
    if ((number - 1) === -1) {
      document.querySelectorAll(".item")[4].classList.add("prev");
    }else{
  ...
  return (
    <div className='w-full ml-[240px] text-white h-max flex flex-col gap-14'>
        {/* <Hero/> */}
        <div className=' overflow-hidden w-full h-96 relative'>
          <div className="items">
            <div className="item flex active relative">
              ...
              <img alt='' src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/gym-and-bodybuilding-youtube-thumbnail-design-template-4bf75ac296b4c72ff2221ff1ee2e8c25_screen.jpg?ts=1594926996" />
            ...
            <div className="item flex next relative">
        ...
        <div className='px-6 h-max flex flex-col justify-center items-start gap-10'>
            <h2 className='font-semibold mb-2 text-white text-xl'>
              Recent<span className='text-[#17c964]'> Uploads</span>
            </h2>
        ...
        <div className='px-6 h-max flex flex-col justify-center items-start gap-10'>
            {/* <h2 className='font-semibold mb-2 text-white text-xl'>
                Your <span className='text-[#17c964]'> Video Timeline</span>
            </h2> */}
            <div>
